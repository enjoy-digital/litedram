...
static const struct sdram_phy_t sdram_phys[] = {
	/* sdram */
	{
		...
		sdram_dfii_pi1_address_write, /* wr */
		{
		...
		sdram_dfii_pi1_baddress_write, /* wr */
		{
...
static inline __attribute__((always_inline)) void sdram_dfii_piwr_address_write(uint16_t v) { sdram_dfii_pi1_address_write(v); }
static inline __attribute__((always_inline)) void sdram_dfii_pird_baddress_write(uint8_t v) { sdram_dfii_pi1_baddress_write(v); }
static inline __attribute__((always_inline)) void sdram_dfii_piwr_baddress_write(uint8_t v) { sdram_dfii_pi1_baddress_write(v); }
static inline __attribute__((always_inline)) void command_prd(uint8_t v) { sdram_phy_sdram_command_p1(v); }
static inline __attribute__((always_inline)) void command_pwr(uint8_t v) { sdram_phy_sdram_command_p1(v); }
